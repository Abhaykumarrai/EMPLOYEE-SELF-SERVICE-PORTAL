...
if (strlen($_SESSION['etmsaid']==0)) {
 ...
 $eid=$_GET['editid'];
$sql="update tbldesignation set Designation=:designation where ID=:eid";
$query=$dbh->prepare($sql);
$query->bindParam(':designation',$designation,PDO::PARAM_STR);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
  echo '<script>alert("Designation name has been updated")</script>';
}
...
<html lang="en">
   <head>
      <title>fssai Employee Self service || Update Designation</title>
                                          ...
                                          <div class="padding_infor_info">
                                             <div class="alert alert-primary" role="alert">
                                                <form method="post">
                                                   <?php
$eid=$_GET['editid'];
$sql="SELECT * from  tbldesignation where ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
