                              ...
                              <div class="table_section padding_infor_info">
                                 <div class="table-responsive-sm">
                                    <table class="table table-bordered">
                                       ...
                                       <tbody>
                                          <?php
$sql=$sql="SELECT tbleoffice.ID as tid,tbleoffice.DeptID,tbleoffice.E_Office,tbleoffice.StartDate,tbleoffice.EndDate,tbldepartment.DepartmentName,tbldepartment.ID as did,tblemployee.EmpName,tblemployee.EmpId from tbleoffice join tbldepartment on tbldepartment.ID=tbleoffice.DeptID join tblemployee on tblemployee.ID=tbleoffice.Assignto";
$query = $dbh -> prepare($sql);
$query->execute();
