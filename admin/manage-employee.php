...
<html lang="en">
   <head>
      ...
      <title>fssai Employee self service|| Manage Employee</title>
...
{               ?> 
                                          <tr>
                                             ...
                                             <td><a href="edit-employee.php?editid=<?php echo htmlentities ($row->eid);?>" class="btn btn-primary">Edit</a>
                                              <a href="manage-employee.php?delid=<?php echo ($row->eid);?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger">Delete</a>
                                             </td>
