                              ...
                              <div class="table_section padding_infor_info">
                                 <div class="table-responsive-sm">
                                    <table class="table table-bordered">
                                       ...
                                       <tbody>
                                          <?php
$sql="SELECT tblsystem.ID as tid,tblsystem.DeptID,tblsystem.AssignTo,tblsystem.SerialNumber,tblsystem.ModelNumber,tblsystem.StartDate,tblsystem.EndDate,tblsystem.status,tbldepartment.DepartmentName,tbldepartment.ID as did,tblemployee.EmpName,tblemployee.EmpId from tblsystem join tbldepartment on tbldepartment.ID=tblsystem.DeptID join tblemployee on tblemployee.ID=tblsystem.AssignTo ";
$query = $dbh -> prepare($sql);
$query->execute();
...
<td class="font-w600" style="color:green ;"><?php echo "Assigned"; ?></td>
<?php } else { ?>
 <td style="color:red;"><?php  echo "N/A";?></td><?php } ?>
