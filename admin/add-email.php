...
if (strlen($_SESSION['etmsaid']==0)) {
 ...
 $sdate=$_POST['sdate'];
 $tedate=$_POST['tedate'];
$sql="insert into tblemail(DeptID,AssignTo,Email,StartDate,EndDate)values(:deptid,:emplist,:email,:sdate,:tedate)";
...
$query->bindParam(':tedate',$tedate,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("E-mail has been assigned to the employee.")</script>';
echo "<script>window.location.href ='add-email.php'</script>";
  }
  else
    {
